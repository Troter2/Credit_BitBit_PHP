...
-- Volcando datos para la tabla bitbit.tokens: ~11 rows (aproximadamente)
/*!40000 ALTER TABLE `tokens` DISABLE KEYS */;
INSERT INTO `tokens` (`tokenid`, `subject`, `expiration`) VALUES
	('0fdf9c00-1fc0-5af4-a10e-49c2a1dea711', 'secure.jwt.daw.local', 1623272987),
	('15f9c7c2-0b16-5af5-a715-0c0b7a089324', 'secure.jwt.daw.local', 1623273130),
	('23cee969-b1b2-51f1-9c31-e60260bc0fbc', 'secure.jwt.daw.local', 1623273174),
	('26a3810d-7c8b-5d45-ab7d-b0f5e6b18744', 'secure.jwt.daw.local', 1623273058),
	('61695073-856e-5ed3-9882-b95e7fa9f762', 'secure.jwt.daw.local', 1623273119),
	('67b58dde-a377-54e9-81f2-96973422bfc8', 'secure.jwt.daw.local', 1623272957),
	('9c900c77-61be-5b5b-8e22-a56550492424', 'secure.jwt.daw.local', 1623273102),
	('bb35f040-7585-5a06-a372-a2077e4dc360', 'secure.jwt.daw.local', 1623273152),
	('bc984afc-6209-55af-9cb8-3e7d144c7da1', 'secure.jwt.daw.local', 1623273032),
	('df05f29c-2730-5381-8f56-6aa030b18a35', 'secure.jwt.daw.local', 1623272935),
	('e73edcc1-baaf-5a0a-b4db-72011b40e587', 'secure.jwt.daw.local', 1623273114);
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `city`) VALUES
	...
	(21, '::1', 'user', '$2y$10$6CYfjRdPmKkOZ3292WEMcugoWK13xFd6az2VW2Wr3heUm1jvkowW.', 'user@user.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1620814520, 1623272395, 1, 'user', 'user', 'user', '', 'user'),
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `inci_user_app` AS SELECT incidencies.id_inci,status.`desc`,incidencies.id_user_propietari, incidencies.nom_propietari, incidencies.marca, incidencies.model, incidencies.numero_serie, incidencies.tlf, incidencies.desc_averia,incidencies.diagnosis_prev, incidencies.entry_date,incidencies.out_date, incidencies.uuid FROM incidencies INNER JOIN status ON incidencies.id_estat = status.id_estatus ;
